...
const PILL = (active) => ({
  ...
  border: `1px solid ${active ? "#1a5080" : "#1a3050"}`,
  color: active ? "#4fc3f7" : "#2a5070",
  padding: "2px 9px",
  fontSize: "0.68rem",
  borderRadius: "4px",
  cursor: "pointer",
...
const S = {
  ...
  title: { fontSize: "1.9rem", letterSpacing: "0.25rem", marginBottom: "0.4rem", color: "#4fc3f7", textAlign: "center" },
  ...
  card: { background: "#0a1220", border: "1px solid #1a3050", borderRadius: "8px", padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1rem" },
  formCard: { width: "320px", flexShrink: 0 },
  listCard: { flex: 1, minWidth: "300px" },
  cardHead: { fontSize: "0.68rem", letterSpacing: "0.18rem", color: "#2a6a9a", borderBottom: "1px solid #1a3050", paddingBottom: "0.65rem", marginBottom: "0.1rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" },
  headRight: { display: "flex", alignItems: "center", gap: "0.4rem", flexWrap: "wrap" },
  label: { fontSize: "0.65rem", letterSpacing: "0.13rem", color: "#2a6a9a", marginBottom: "0.35rem", display: "block" },
  input: { background: "#050d1a", color: "#81d4fa", border: "1px solid #1a3050", padding: "0.55rem 0.85rem", fontSize: "0.95rem", borderRadius: "5px", width: "100%", boxSizing: "border-box", outline: "none" },
  searchInput: { background: "#050d1a", color: "#81d4fa", border: "1px solid #1a3050", padding: "0.4rem 0.75rem", fontSize: "0.85rem", borderRadius: "5px", width: "100%", boxSizing: "border-box", outline: "none" },
  textarea: { background: "#050d1a", color: "#81d4fa", border: "1px solid #1a3050", padding: "0.55rem 0.85rem", fontSize: "0.9rem", borderRadius: "5px", width: "100%", boxSizing: "border-box", outline: "none", minHeight: "90px", resize: "vertical", fontFamily: "Arial, sans-serif" },
  descInput: { background: "#060f1e", color: "#81d4fa", border: "1px solid #1a4060", padding: "2px 6px", fontSize: "0.78rem", borderRadius: "3px", outline: "none", width: "100%", boxSizing: "border-box", fontFamily: "Arial, sans-serif", marginTop: "2px" },
  iconBtn: { background: "none", border: "1px solid #1a3a5a", color: "#4fc3f7", cursor: "pointer", borderRadius: "4px", padding: "2px 8px", fontSize: "0.9rem" },
  output: { background: "#050d1a", border: "1px solid #1a3050", borderRadius: "5px", padding: "0.85rem", color: "#81d4fa", fontSize: "0.82rem", whiteSpace: "pre-wrap", lineHeight: "1.6" },
  row: (conf) => ({ display: "flex", alignItems: "flex-start", gap: "0.7rem", padding: "0.65rem 0", borderBottom: "1px solid #0d1e30", background: conf ? "rgba(180,0,30,0.05)" : "transparent", borderRadius: conf ? "4px" : "0", transition: "background 0.2s" }),
  rowInfo: { flex: 1, minWidth: 0 },
  rowTop: { display: "flex", alignItems: "center", gap: "0.45rem" },
  dot: (st) => ({
    width: "7px", height: "7px", borderRadius: "50%", flexShrink: 0, marginTop: "1px",
    background: st === "ok" ? "#4caf50" : st === "error" ? "#ef5350" : st === "checking" ? "#ffd700" : "#1a3050",
    boxShadow: st === "ok" ? "0 0 4px #4caf50" : st === "error" ? "0 0 4px #ef5350" : "none",
    transition: "background 0.3s, box-shadow 0.3s",
  }),
  rowName: { color: "#4fc3f7", fontSize: "0.88rem", textDecoration: "none", fontWeight: "bold", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1, minWidth: 0 },
  rowCode: { color: "#1a4060", fontSize: "0.68rem", flexShrink: 0 },
  rowMeta: { color: "#1a4060", fontSize: "0.7rem", marginTop: "1px", marginLeft: "12px" },
  rowDesc: { color: "#2a6a9a", fontSize: "0.78rem", marginTop: "3px", marginLeft: "12px", fontStyle: "italic", cursor: "pointer" },
  rowDescEmpty: { color: "#1a3050", fontSize: "0.78rem", marginTop: "3px", marginLeft: "12px", fontStyle: "italic", cursor: "pointer" },
  actions: { display: "flex", alignItems: "center", gap: "0.4rem", flexShrink: 0, flexWrap: "wrap", justifyContent: "flex-end" },
  confirmText: { fontSize: "0.7rem", color: "#ef5350", letterSpacing: "0.05rem" },
  emptyText: { color: "#1a3050", fontSize: "0.82rem", fontStyle: "italic", textAlign: "center", padding: "1rem 0" },
  nav: { marginTop: "2rem", color: "#2a4a6a", fontSize: "0.75rem", letterSpacing: "0.1rem" },
  navLink: { color: "#2a6a9a", textDecoration: "none" },
};
